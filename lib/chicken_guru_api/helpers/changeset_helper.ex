defmodule CG.Helpers.ChangesetHelper do
  import Ecto.Changeset, only: [update_change: 3, validate_format: 4, unsafe_validate_unique: 4]
  ...
  def email_check(%Ecto.Changeset{} = changeset, field, opts \\ %{}) when is_atom(field) do
    format_message = opts[:format_message] || "is_invalid"
    unique_message = opts[:unique_message] || "is_not_unique"
    ...
    |> unsafe_validate_unique(field, CG.Repo, message: unique_message)
  end
  ...
  def security_check(changeset, fiels, opts \\ %{})
